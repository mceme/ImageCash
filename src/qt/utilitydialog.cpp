    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("IMGC Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About IMGC Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  IMGC-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the IMGC in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 IMGC, 0.1 IMGC, 1 IMGC and 10 IMGC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://IMGCpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://IMGCpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("IMGC Core is shutting down...") + "<br /><br />" +
