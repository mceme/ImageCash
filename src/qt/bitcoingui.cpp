...
// Copyright (c) 2017-2018 The ImageCash Core developers
    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("ImageCash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a IMG address"));
...
//receive
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ImageCash: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About ImageCash Core"), this);
    aboutAction->setStatusTip(tr("Show information about ImageCash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ImageCash Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ImageCash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ImageCash addresses"));
    ...
    openAction->setStatusTip(tr("Open a ImageCash: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ImageCash Core help message to get a list with possible ImageCash Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("ImageCash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ImageCash network", "", count));
    } else {
...
{
    QString strTitle = tr("ImageCash Core"); // default title
    ...
    // Append title to "ImageCash Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
