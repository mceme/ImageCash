    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("ImgCash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a IMGC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and imgcash: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About ImgCash Core"), this);
    aboutAction->setStatusTip(tr("Show information about ImgCash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ImgCash Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Imgcash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Imgcash addresses"));
    ...
    openAction->setStatusTip(tr("Open a Imgcash: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ImgCash Core help message to get a list with possible ImgCash Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("ImgCash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ImgCash network", "", count));
    } else {
...
{
    QString strTitle = tr("ImgCash Core"); // default title
