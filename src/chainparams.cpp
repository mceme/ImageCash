...
public:
    CMainParams() {
        ...
        consensus.nPowKGWHeight = 2500;
        consensus.nPowDGWHeight = 5000;
        ...
        checkpointData = (CCheckpointData){
				 ...
				 ( 1000, uint256S("0x00000000f10e23b1d6e91eef1f68b492945a4fcf182f4a7f55d25cff5ec1785f"))
				 ( 5000, uint256S("0x0000000007acd40293851bbe0a4fb35508f6d2f38b53f3292061f5ad1f9115d1")),
				 1529304592,
				 5019,
                 500
             };
...
//                  }
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0xb1c703380ae5a1bdc9ba5a3cba0900c216a7e6497f73b6323ac5e56cc95d6ec0")),
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1417713337, 1529084551, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
